...
alpha_tree <- read.tree("L2_DAA2_cluster.nwk")
beta_tree <- read.tree("L2_DAB2_cluster.nwk")
...
alpha_col <- c(rep("#7139c4", 3), rep("#0096FF", 1), rep("#FF9300", 1), rep("#FF0000", 20), rep("#809400", 1), rep("#02A252", 8), rep("#FF40FF", 12), rep("#A05800", 7))
...
pdf("tanglegram_L2.pdf", width = 6, height = 10)
