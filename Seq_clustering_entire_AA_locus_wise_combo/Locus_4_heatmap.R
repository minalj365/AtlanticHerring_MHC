...
aln_file_alpha <- "AA_aln_DAA4.fa"; row_title <- "Alleles of DAA4.1 and DAA4.2"
aln_file_beta <- "AA_aln_DAB4.fa"; col_title <- "Alleles of DAB4.1 and DAB4.2"
Locus <- "L4"
...
## Annotation for L4
x <- c(rep("4b",19), rep("4c",1), rep("4a",11))

Locus_annot <- data.frame(Group = x)
annot_col_1 <- list(Group=c("4b"="#ff6900", "4c"="#CE16EB", "4a"="#4169e1"))
annot_col_2 <- list(Group=c("4b"="#FF690080", "4c"="#CE16EB80", "4a"="#4169E180"))
...
## Make a heatmap, with annotation
    ...
    grid.text("b", x = unit(3, "mm"), y = unit(1, "npc") - unit(0.5, "mm"),
